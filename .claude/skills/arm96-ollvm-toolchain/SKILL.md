...
see `.claude/instructions/build_and_debug*.md`; the repo path is the mount of that
...
`.claude/context/arm96_loader_vmp_plan.md` and the `ollvm-silently-off` memory.
